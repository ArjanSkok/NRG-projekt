...
In `sam2\_segment.py`, set:

```python

SAM2\_CHECKPOINT = "path/to/your/checkpoint.pt"

SAM2\_CONFIG = "configs/sam2.1/sam2.1\_hiera\_l.yaml"

filename\_base = "./data/your\_file.laz"
...
\- `ablation\_views.png` — effect of number of views on segmentation quality

\- `ablation\_threshold.png` — effect of voting threshold on precision/recall/F1
